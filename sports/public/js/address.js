window.onload = function(){
    ...
    function aa(){
        ...
        main[1].innerHTML+=
            ...
            rightbtn.onclick = function(){
                var len=localStorage.getItem('mun')
        ...
        for(var i=0;i<alist.length;i++){
            ...
            alist[i].onclick=function(){
                ...
                localStorage.setItem('mun',this.index)
            }
        }
    }
    ...
    function bb(){
        ...
        console.log(localStorage.getItem('adss'))
        console.log(mainb)
        console.log(list2)
        mainb.innerHTML = ''
        mainb.innerHTML +=
        ...
        `
        arr=JSON.parse(window.localStorage.getItem('address')) ;
        arr.splice(mainb.innerHTML,1)
        localStorage.setItem("address", JSON.stringify(arr));
