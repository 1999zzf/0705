...
//   ]
  ...
  router.get('/dd',async(ctx,next)=>{
    ...
    var con=response.data.data.map((v,i)=>{
      console.log(v);
      return v
    })
    console.log(con)
  ...
  router.get('/aa',async(ctx,next)=>{
    ...
    var bed=response.data.data.map((v,i)=>{
      console.log(v);
      return v
    })
    console.log(bed)
  ...
  router.get('/it',async(ctx,next)=>{
    ...
    var item=response.data.data.map((v,i)=>{
      console.log(v);
      return v
    })
    ctx.body={
